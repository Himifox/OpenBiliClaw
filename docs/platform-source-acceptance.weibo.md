...
| Desktop / mobile recommendation and extension connector surfaces | required | PASS | Existing Web surface suites cover author, text cards, shares, delight and local-only saved membership; extension suites cover source identity, readiness and task routing |
