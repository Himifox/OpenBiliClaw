...
def build_openclaw_adapter_services() -> OpenClawAdapterServices:
    ...
    soul_engine = SoulEngine(
        ...
        awareness_hard_input_tokens=int(getattr(soul_cfg, "awareness_hard_input_tokens", 32_000)),
        awareness_max_calls_per_cycle=int(getattr(soul_cfg, "awareness_max_calls_per_cycle", 2)),
